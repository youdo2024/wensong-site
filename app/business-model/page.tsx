...
const ROWS: [string, string][] = [
  ...
  ["業務內容", "數位內容製作與銷售（Podcast 節目、節目筆記、逐字稿）、周邊商品零售（實體商品宅配或超商取貨）"],
  ["支持方案之性質", "數位內容服務之銷售。買受人付款後取得：《問爽的 WenSong》Podcast 節目與持續公開的內容、支持者專屬數位圖像下載、訂單確認信與電子發票。屬交易行為，非捐贈、非募資、非《公益勸募條例》之勸募"],
  ["方案型態", "單次支持（一次性）／每月支持（繼續性服務契約，信用卡按月扣款，買受人可隨時登入帳號停止）"],
  ["發票開立", "每筆交易由光貿電子發票加值中心自動開立雲端發票，品名「數位內容服務」，寄送至買受人 Email；需載具、捐贈或統編者由客服協助處理"],
  ["定價", "由買受人於本站提供之級距或自訂金額中選擇，單筆下限 NT$100"],
  ["金流", "藍新金流（NewebPay）。支持信用卡與 ATM 轉帳，本站不經手、不儲存卡號"],
  ["退款政策", "數位內容一經提供即完成，依消保法第 19 條第 1 項但書不適用七日猶豫期；重複扣款或金額錯誤個案協助，循原付款方式退回（詳見 www.wensong.tw/returns）"],
