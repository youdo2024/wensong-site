  ...
  return (
    <>
      ...
      <div className="frame" style={{ maxWidth: 680, padding: "48px 20px 100px" }}>
        ...
        <p style={p}>
          「問爽的」3 個字，來自維尼本名汶儀的汶、安妮本名宋安妮的宋。汶宋，問爽的。
          {BRAND.name}是維尼跟安妮的聊天節目。一個問題很多，一個開餐廳，找餐廳老闆、創業的人聊，把每個人都當作第一次認識，問到兩個人都覺得夠了為止。
          {first ? `從 ${first.slice(0, 4)} 年 ${Number(first.slice(5, 7))} 月開始，` : ""}目前 {count} 集，正篇之外還有聽眾投稿的秘密特集。
        </p>
        <p style={p}>
