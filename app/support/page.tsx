...
import { enabledPays, monthlyExternalUrl, supportEnabled, supportMode, supportUrl, applePayOnsiteEnabled } from "@/lib/shop";
    ...
    <>
      ...
      <div className="frame" style={{ maxWidth: 680, padding: "56px 20px 100px" }}>
        ...
        {sp.error === "phone" ? (
          ...
          <p className="msg-err">目前沒有可用的金流。站長請到後台「設定・贊助」：每月定額選「站內藍新信用卡定期定額」，或在「前往指定頁面贊助」填外部網址。</p>
        ) : sp.error === "payoff" ? (
